        ...
        {userCompletion ? (
          ...
          <div className="challenge-preview">
            ...
            <div className="challenge-description">
              <h3>🎯 Your Mission</h3>
              <p>
                Analyze this unique foreclosure scenario generated by AI. You'll have 5 minutes
                to review the property, run limited due diligence to uncover red flags, and
                commit at the gavel: BUY or WALK AWAY.
              </p>
